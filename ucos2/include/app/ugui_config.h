...
// Example for s5pv210
typedef         unsigned char  UG_U8;                                   /* 无符号8位整型变量                        */
typedef         signed   char  UG_S8;                                   /* 有符号8位整型变量                        */
typedef         unsigned short UG_U16;                                          /* 无符号16位整型变量                       */
typedef         signed   short UG_S16;                                          /* 有符号16位整型变量                       */
typedef         unsigned int   UG_U32;                                          /* 无符号32位整型变量                       */
typedef         signed   int   UG_S32;                                          /* 有符号32位整型变量                       */
